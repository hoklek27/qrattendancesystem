-- Database setup for QR Attendance System
...
-- Update the password hashes to use simple passwords
-- Replace the existing INSERT statements for users with these:

-- Remove the old INSERT statements and replace with these new ones:
DELETE FROM users;

-- Insert default admin user with plain password: admin123
...
-- Insert sample dosen with plain password: dosen123
INSERT INTO users (username, password, full_name, email, role, nim_nip) VALUES 
...
-- Insert sample mahasiswa with plain password: mahasiswa123
INSERT INTO users (username, password, full_name, email, role, nim_nip) VALUES 
